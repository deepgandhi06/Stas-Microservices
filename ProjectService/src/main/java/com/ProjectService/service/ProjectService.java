...
public class ProjectService {
    ...
    public Long createTaskForProject(Long projectId, String title, String description, LocalDate dueDate, Long assignedById) {
        ...
        if (response == null) throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR, "Task service returned null.");

        // We do NOT keep Task entity locally. Optionally store task id mapping if needed.
